...
(function() {
    // for name array we still need to update the names to hold _sysinfo.txt
    ...
    for (let i = 0; i < name.length; i++) {
        ...
        // SHOWS INFO LIST WHEN VM NAME BUTTON IS CLICKED
        document.getElementById("vm_" + i).addEventListener("click", function() {
            ...
            info_list_node.setAttribute("id", "vm_info_list");
